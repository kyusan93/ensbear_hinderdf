...
curl https://github.com/3gstudent/Eventlogedit-evtx--Evolution/releases/download/v1.1.0/Eventlogedit-evtx--Evolution-master-v1.1.zip -o Eventlogedit-evtx
tar -xf Eventlogedit.evtx
